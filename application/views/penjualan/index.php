...
<div class="row">
    <div class="col-lg-4 col-md-4">
        <!--begin::Callout-->
        <a href="<?= base_url("/index.php/penjualan/order_request") ?>">
    ...
    <div class="col-lg-4 col-md-4">
        <!--begin::Callout-->
        <a href="<?= base_url("/index.php/penjualan/pos") ?>">
            <div class="card card-custom wave wave-animate-fast wave-info mb-8 mb-lg-0">
                <div class="card-body">
                    <div class="d-flex align-items-center p-5">
                        <!--begin::Icon-->
                        <div class="mr-6">
