<div class="form-group">
    ...
    <?php } else if ($type == "text" || $type == "number" || $type == "date") { ?>
        <input type="<?= $type ?>" name="<?= $name ?>" class="form-control" <?= isset($id) && $id ? "id='$id'" : "" ?> <?= isset($placeholder) && $placeholder ? "placeholder='$placeholder'" : "" ?> <?= isset($required) && $required ? "required" : "" ?> <?= isset($value) && $value ? "value='$value'" : "" ?> <?= isset($autocomplete) && $autocomplete ? "autocomplete='".$autocomplete."'" : "" ?>  />
