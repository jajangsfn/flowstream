        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            ...
            <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body text-center pt-4">
                    ...
                    <!--end::Toolbar-->
                    <a href="<?= base_url("/index.php/setting/parameter/cabang/$data_branch->id") ?>">
                        <!--begin::User-->
                        <div class="pb-2">
                        ...
                        <!--begin::Name-->
                        <div class="my-2">
                            <a href="<?= base_url("/index.php/setting/parameter/cabang/$data_branch->id") ?>" class="text-dark font-weight-bold text-hover-primary font-size-h4">
                                <?= $data_branch->name ?>
                            </a>
                        </div>
                        <!--end::Name-->
                        <!--begin::Label-->
                        <a href="<?= base_url("/index.php/setting/parameter/cabang/$data_branch->id") ?>" class="btn btn-sm btn-info font-weight-bold readonly" style="cursor: unset;"><?= $data_branch->code ?></a>
                        <!--end::Label-->
                    </a>
                </div>
                <!--end::Body-->
