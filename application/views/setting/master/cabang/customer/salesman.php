                        ...
                        <?php foreach ($data_salesman as $key => $sman) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-icon btn-sm btn-light-success" onclick="edit(<?= $sman->id ?>, '<?= $sman->employee_id ?>', '<?= $sman->phone ?>')">
...
<div class="modal fade" id="tambah_salesman" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <form action="<?= base_url("/index.php/api/add_usr_salesman") ?>" method="POST" class="modal-content">
            <input type="hidden" name="partner_id" value="<?= $data_customer->id ?>">
            ...
            <div class="modal-body row">
                <div class="col-md-12">
                    <?= $this->load->view("component/input/flowstream_select", array(
                        ...
                        "manage_url" => base_url("/index.php/setting/master/cabang/$data_branch->id/employee"),
...
<div class="modal fade" id="edit_salesman" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <form action="<?= base_url("/index.php/api/edit_usr_salesman") ?>" method="POST" class="modal-content">
...
<div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="<?= base_url("/index.php/api/delete_usr_salesman") ?>" method="POST" class="modal-content">
