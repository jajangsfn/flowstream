          ...
          <div class="row mb-3"> 
            ...
            <div class="col-md-3">
                <div class="input-group mb-3">
                      <input type="text" name="nro" id="nro" class="form-control" placeholder="No Receive Order. . ." aria-label="" aria-describedby="basic-addon1" value="<?=($master) ? $master[0]->reference_no : ""?>">
