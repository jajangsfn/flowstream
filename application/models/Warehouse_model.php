...
class Warehouse_model extends CI_Model
{
	...
	function get_all($where = null, $group_by = null) {
		...
		$this->db->select("tab1.*, sum(tab2.quantity)total_item,tab2.goods_id,tab2.quantity,tab2.aisle_no,tab2.stacking_no,tab2.description desc_detail,tab3.name previous_warehouse_name,tab4.name actual_warehouse_name,tab5.barcode,tab5.brand_description,tab5.sku_code,tab5.plu_code");
